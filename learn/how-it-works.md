...
As of March 2026, the vProgs framework proposes a two-level proving pipeline (8 PRs in review):
...
Guest programs are written using a Solana-like API with resources, instructions, and program contexts. Once merged, builders will have a functional execution and proving pipeline providing a minimal environment to build and test guest logic.
